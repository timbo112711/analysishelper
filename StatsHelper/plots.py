...
def histogram(data, n_bins, x_label, y_label, title, color, fig_filename):
    '''
    ...
    ax = plt.subplot()
    # Plot the data
    ax.hist(data, n_bins = n_bins, color = color)
...
def overlaid_histogram(data1, data2, n_bins, data1_name, data2_name, title, fig_filename):
    '''
    ...
    # Create the plot
    ax = plt.subplot()
    ax.hist(data1, bins = bins, color = 'lightblue', alpha = 1, label = data1_name)
    ax.hist(data2, bins = bins, color = 'green', alpha = 0.75, label = data2_name)
    # Label the axis's
...
def scatterplot(x_data, y_data, x_label, y_label, title, color, s, alpha, fig_filename):
    ''' 
